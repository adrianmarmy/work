...
program
  ...
  .option('-d, --day <tag>', 'Wochentag: 1-7, Mo-So, heute, morgen')
...
program
  ...
  .option('-d, --day <tag>', 'Nach Wochentag filtern: 1-7, Mo-So, heute')
  ...
  .option('--today', 'Nur Tasks von heute anzeigen')
  .option('--by-day', 'Nach Wochentagen gruppiert anzeigen')
